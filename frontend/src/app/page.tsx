        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative ml-2">
            <button
              ...
              className="flex items-center gap-2.5 pl-2 pr-1.5 py-1.5 hover:bg-gray-100 rounded-xl transition-all border border-transparent hover:border-gray-200"
            >
              <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center border border-blue-200 shadow-sm overflow-hidden">
            ...
            <AnimatePresence>
              {isProfileOpen && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-2 w-56 bg-white border border-gray-200 rounded-2xl shadow-2xl z-[100] overflow-hidden p-1.5"
                  onClick={(e) => e.stopPropagation()}
                >
                  <div className="p-3 mb-1 border-b border-gray-100 flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-gray-400 truncate font-bold">{user?.email}</p>
                    </div>
                  </div>
